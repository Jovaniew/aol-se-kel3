                ...
                <div class="container-fluid">
                    <div id="page-inner">
                        ...
                        if (isset($_GET['halaman'])) {
                            ...
                            } elseif ($_GET['halaman'] == "produkfotohapus") {
                                include 'produkfotohapus.php';
                            } elseif ($_GET['halaman'] == "produkukuranhapus") {
                                include 'produkukuranhapus.php';
                            } elseif ($_GET['halaman'] == "produkukuranubah") {
                                include 'produkukuranubah.php';
                            } elseif ($_GET['halaman'] == "produkwarnahapus") {
                                include 'produkwarnahapus.php';
                            } elseif ($_GET['halaman'] == "logout") {
                                include 'logout.php';
                            } elseif ($_GET['halaman'] == "chat") {
                                include 'chat.php';
